...
<body>
	<div id="image">
		...
		<p id="hit">
			<a href="http://codeup.dev/ping.php?rally=<?= $rally + 1 ?>&player1=<?= $player1 ?>&player2=<?= $player2 ?>">Hit</a>
		</p>
		<p id="miss">
			<a href="http://codeup.dev/ping.php?player1=<?= $player1 + 1 ?>&player2=<?= $player2 ?>">Miss</a>
		</p>
